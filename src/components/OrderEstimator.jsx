...
export default function OrderEstimator() {
  ...
  const branches = [
    { name: "Karawang", phone: "628", address: "Galuh Mas" },
    { name: "Bekasi", phone: "628", address: "Mayor Oking" },
  ];
  ...
  const generateMessage = () => {
    ...
    const cleanerText =
      cleanerQty > 0 ? `${cleanerQty} Botol NexQ Cleaner 30ml` : "Tidak Ada";
    ...
    >
      <div className="container">
        <div className="section-title">
          ...
          <p>
            Konfigurasikan detail kebutuhan lensa optik Anda untuk mendapatkan
            draf pesanan otomatis yang siap dikirim langsung ke WhatsApp sales
            kami.
          </p>
        </div>
            ...
            >
              ...
              <div>
                ...
                >
                  <button
                    onClick={() =>
                      cleanerQty > 0 && setCleanerQty(cleanerQty - 1)
                    }
                    style={{
                      width: "40px",
                      height: "40px",
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "0.85rem", color: "#93c5fd" }}>
                Klik tombol di bawah — pesan sudah otomatis terisi ke chat sales
                cabang <strong style={{ color: "white" }}>{branch}</strong>.
              </p>
            </div>
            ...
            >
              {[
                ...
                {
                  label: "Jasa Faset",
                  value: needFaset ? "Ya — Potong Presisi" : "Tidak",
                },
                {
                  label: "Jumlah",
                  value: `${quantity} Pasang${cleanerQty > 0 ? ` + ${cleanerQty} NexQ Cleaner` : ""}`,
                },
