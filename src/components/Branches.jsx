    ...
    <section id="cabang" className="section">
      <div className="container">
        <div className="section-title">
          ...
          <p>Kunjungi gudang distribusi kami atau hubungi perwakilan sales untuk melihat contoh produk dan berkonsultasi mengenai kemitraan optik.</p>
        </div>
          ...
          {branchData.map((branch, idx) => (
            ...
            >
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '1.4rem', fontWeight: 800, color: 'var(--primary-blue)', marginBottom: '4px' }}>
                  {branch.name}
                </h3>
                <p style={{ fontSize: '0.85rem', color: 'var(--brand-orange)', fontWeight: 700, letterSpacing: '0.5px' }}>
                  {branch.subtitle}
                </p>
              </div>

              {/* Branch Details */}
              <div style={{ padding: '30px', display: 'flex', flexDirection: 'column', gap: '20px', flexGrow: 1 }}>
                
                {/* Address */}
                <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                  <div style={{ color: 'var(--brand-orange)', marginTop: '3px' }}>
                    <MapPin size={20} />
                  </div>
                  <div>
                    <h4 style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--text-dark)', marginBottom: '4px' }}>Alamat Distribusi</h4>
                    <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', lineHeight: '1.5' }}>{branch.address}</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--text-dark)', marginBottom: '4px' }}>Jam Operasional</h4>
                    <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', lineHeight: '1.5' }}>{branch.hours}</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--text-dark)', marginBottom: '4px' }}>Kontak WhatsApp</h4>
                    <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', lineHeight: '1.5' }}>{branch.phone}</p>
                  </div>
                </div>
